<template>
    <div class="w-full flex flex-col border-2 border-red-500">
        ...
        <div class="w-full h-2 relative">
            <div class="w-full h-1 absolute top-0 bg-black bottom-0 left-0"></div>
            <div class="w-1 h-full absolute top-0 bg-slate-400 z-10" :style="'left: '+playTime/totalTime*100+'%;'"></div>
        </div>
        <div class="flex gap-2 z-20 justify-center">
        ...
        <button 
            @click="togglePlay"
            class="p-0 rounded-full hover:drop-shadow-xl transition-colors">
